...
export function AcademicTemplate({ resumeData, isDark }: TemplateProps) {
  const accentColor = resumeData.layout.accentColor || '#1f2937';
  const fontFamily = resumeData.layout.fontFamily || 'Times New Roman, serif';
  ...
  return (
    <div className="p-12 h-full overflow-y-auto" style={{ fontFamily }}>
      {renderHeader(resumeData, accentColor, fontSize, 'academic')}
