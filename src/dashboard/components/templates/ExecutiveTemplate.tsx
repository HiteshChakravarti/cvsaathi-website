...
export function ExecutiveTemplate({ resumeData, isDark }: TemplateProps) {
  const accentColor = resumeData.layout.accentColor || '#d97706';
  const fontFamily = resumeData.layout.fontFamily || 'Garamond, serif';
  ...
  return (
    <div className="p-12 h-full overflow-y-auto" style={{ fontFamily }}>
      {renderHeader(resumeData, accentColor, fontSize, 'executive')}
