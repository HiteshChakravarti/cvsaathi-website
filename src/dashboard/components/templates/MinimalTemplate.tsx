...
export function MinimalTemplate({ resumeData, isDark }: TemplateProps) {
  const accentColor = resumeData.layout.accentColor || '#374151';
  const fontFamily = resumeData.layout.fontFamily || 'Helvetica, Arial, sans-serif';
  ...
  return (
    <div className="p-12 h-full overflow-y-auto" style={{ fontFamily }}>
      {renderHeader(resumeData, accentColor, fontSize, 'minimal')}
